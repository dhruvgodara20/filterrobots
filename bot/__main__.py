...
PM_START_TEXT = """
*Hello* *{}*
*My name is* *{}*\n\n`You Can Add any kind of Filters to This Bot! JOIN US - @HINDI_HD_MOOVIES`
...
if START_IMG is None:
    img = "https://telegra.ph/JOIN-HINDI-HD-MOOVIES-02-12"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️Help",callback_data="help_back"),InlineKeyboardButton(text="JOIN US",url="https://t.me/joinchat/SvmWATxeZ_dAZDBg")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="😴Contact Creator",url="https://t.me/joinchat/SvmWATxeZ_dAZDBg")]]))
        return
